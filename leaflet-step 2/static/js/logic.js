// Store our API endpoint inside queryUrl//using the URL of this JSON to pull in the data for our visualisation.
...
function createFeatures(earthquakeData) {
    ...
    // Check on coordinates and magnitude data based on querying the url
